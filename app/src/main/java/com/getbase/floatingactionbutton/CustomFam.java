...
/**
 * Created by Angel on 24/03/2015.
 */
...
public class CustomFam extends ViewGroup {
    ...
    public CustomFam(Context context) {
        this(context, null);
    }

    public CustomFam(Context context, AttributeSet attrs) {
        super(context, attrs);
        init(context, attrs);
    }

    public CustomFam(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void createAddButton(Context context) {
        ...
        mAddButton.setIcon(com.example.angel.viewpager2.R.drawable.pencil_ico);
